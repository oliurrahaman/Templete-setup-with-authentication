        ...
        <div class="table-responsive my-2">
            <table class="table table-bordered table-striped" id="dataTable">
                ...
                <tr>
                    ...
                    <th scope="col">ClientSlug Name</th>
                ...
                <tbody>
                    @foreach ($testimonials as $testimonial)
                        <tr>
                            ...
                            {{-- <td><img src="{{ asset('uploads/testimonial') }}/{{ $testimonial->testimonial_image }}" alt="" class="img-fluid rounded h-50 w-50"></td> --}}
                            <td>{{ $testimonial->updated_at->format('d M Y') }}</td>
                            <td>

                                <img src="{{ asset('upload/testimonials') }}/{{ $testimonial->client_image }}" alt="" class="img-fluid rounded-circle">
                            </td>
